...
const CLOTHING_OPTIONS: Record<string, Array<{ value: string; label: string; categorySlug: string }>> = {
  ...
  Life: [
    { value: "Textiles & Throws", label: "Textiles & Throws", categorySlug: "textiles" },
    { value: "Wall Art", label: "Wall Art", categorySlug: "wall-art" },
    { value: "Candles & Fragrance", label: "Candles & Fragrance", categorySlug: "fragrance" },
    { value: "Tableware", label: "Tableware", categorySlug: "tableware" },
    { value: "Skincare", label: "Skincare", categorySlug: "skincare" },
    { value: "Body Care", label: "Body Care", categorySlug: "body-care" },
    { value: "Fragrance", label: "Fragrance", categorySlug: "fragrance" },
