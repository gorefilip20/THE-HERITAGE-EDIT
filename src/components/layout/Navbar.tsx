...
const MEGA_MENU: MegaMenuCategory[] = [
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: "Dresses", href: "/shop?department=Women&clothingType=Dresses" },
          { label: "Tops & Blouses", href: "/shop?department=Women&clothingType=Tops%20%26%20Blouses" },
          { label: "Coats & Jackets", href: "/shop?department=Women&clothingType=Coats%20%26%20Jackets" },
          { label: "Trousers & Shorts", href: "/shop?department=Women&clothingType=Trousers%20%26%20Shorts" },
        ],
      },
      {
        heading: "Accessories",
        links: [
          { label: "Bags", href: "/shop?department=Accessories&clothingType=Bags" },
          { label: "Jewelry", href: "/shop?department=Accessories&clothingType=Jewelry" },
          { label: "Shoes", href: "/shop?department=Women&clothingType=Shoes" },
          { label: "All Accessories", href: "/shop?department=Accessories" },
        ],
      },
    ],
    featured: {
  ...
  },
  {
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: "Agbada & Robes", href: "/shop?department=Men&clothingType=Agbada%20%26%20Robes" },
          { label: "Tailored Suits", href: "/shop?department=Men&clothingType=Suits%20%26%20Tailoring" },
          { label: "Senator Wear", href: "/shop?department=Men&clothingType=Senator%20Wear" },
          { label: "Native Wear", href: "/shop?department=Men&clothingType=Native%20Wear" },
        ],
      },
      {
        heading: "Accessories",
        links: [
          { label: "Shoes", href: "/shop?department=Men&clothingType=Shoes" },
          { label: "Bags", href: "/shop?department=Accessories&clothingType=Bags" },
    ...
    featured: {
      ...
      href: "/shop?department=Men&clothingType=Agbada%20%26%20Robes",
