  ...
  const itemRows = items.map((item) => `
    <tr><td style="padding: 16px 0; border-bottom: 1px solid #f0f0f0;">
      <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr>
        ${item.imageUrl ? `<td width="72" style="padding-right: 16px; vertical-align: top;"><img src="${item.imageUrl}" alt="${item.name}" width="72" height="90" style="display: block; border-radius: 6px; object-fit: cover; background-color: #f7f7f6;" /></td>` : ""}
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #f7f7f6;"><tr><td align="center" style="padding: 40px 16px;">
    <table cellpadding="0" cellspacing="0" border="0" width="600" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden;">
      ...
      <tr><td style="padding: 36px 40px 24px;">
        ...
        <p style="margin: 0; font-size: 14px; color: #666666;">Your order <strong style="color: #0D2C22;">${orderNumber}</strong> has been confirmed.</p>
      </td></tr>
      ...
      <tr><td style="padding: 0 40px 32px; text-align: center;"><a href="${process.env.NEXT_PUBLIC_APP_URL ?? "https://heritageedit.com"}/account/orders" style="display: inline-block; padding: 14px 32px; background-color: #0D2C22; color: #ffffff; font-size: 13px; font-weight: 600; text-decoration: none; border-radius: 8px;">Track Your Order</a></td></tr>
